...
document.body.appendChild($("p", {}, [
  ...
  "anyone noticed — because the machine never rebooted. The running system is not the next ",
  "generation: a failure that only happens at boot ships silently while uptime accumulates.",
]));
...
document.body.appendChild($("p", {}, [
  ...
  "After touching boot-time provisioning, verify the boot path — the unit ordering and the file ",
  "it produces — not just the live system.",
]));

...
document.body.appendChild($("p", {}, [
  ...
  ": ",
  $("a", { href: "https://services.gradle.org", textContent: "services.gradle.org" }),
  " redirects to GitHub release assets, which are throttled.",
]));
...
document.body.appendChild($("p", {}, [
  ...
  " starts at 2.4.0-Beta2, and the pom 404s on ",
  $("a", { href: "https://repo1.maven.org", textContent: "repo1.maven.org" }),
  " and on the JetBrains redirector (307 to ",
  $("code", { textContent: "artifacts-caching-proxy.aws.intellij.net" }),
  ", then 404). Filed as ",
...
document.body.appendChild($("p", {}, [
  ...
  "), so every dependency is checked against Google Maven first. The Maven Central default is ",
  $("code", { textContent: "repo1.maven.org" }),
  ", overridable via the ",
